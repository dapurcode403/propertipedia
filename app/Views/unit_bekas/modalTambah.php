    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Aktivitas Hari Ini</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="4" required oninvalid="this.setCustomValidity('Keterangan tidak boleh kosong');" onchange="try{setCustomValidity('')}catch(e){};" x-moz-errormessage="Keterangan tidak boleh kosong"></textarea>
